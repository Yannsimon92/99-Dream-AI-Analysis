    ...
    <React.Fragment>
      <nav className="site-nav">
        <div className="inner">
          ...
          <button className="nav-cta">Analyser un rêve</button>
      ...
      <div className={"mobile-drawer" + (open ? " open" : "")}>
        ...
        <a href="#galerie" onClick={() => setOpen(false)} style={{ color: accent }}>Analyser un rêve →</a>
      </div>
    </React.Fragment>
  );
}
    ...
    <section className="hero">
      <div className="container">
        ...
        <div className="actions">
          <button className="btn-primary" style={{ background: accent }}>Analyser un rêve</button>
          <button className="btn-ghost">Voir comment ça marche</button>
        </div>
      </div>
    </section>
  );
